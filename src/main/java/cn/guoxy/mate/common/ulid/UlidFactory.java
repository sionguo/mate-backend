 ...
 *
 * <p>This class is used by {@link UlidCreator}.
 *
 ...
 *
 * <p>Instances of this class can behave in one of two ways: monotonic or non-monotonic (default).
 *
 * <p>If the factory is monotonic, the random component is incremented by 1 if more than one ULID is
 * generated within the same millisecond.
 *
 * <p>The maximum ULIDs that can be generated per millisecond is 2^80.
 */
public final class UlidFactory {
   ...
   *
   * <p>It is equivalent to the default constructor {@code new UlidFactory()}.
   *
   ...
   * Returns a new factory.
   *
   * <p>The given random function must return a long value.
   *
   ...
   * Returns a new factory.
   *
   * <p>The given random function must return a byte array.
   *
