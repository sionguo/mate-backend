 ...
 *
 * <p>KSUID is a 160-bit value that has two parts:
 *
 * <ul>
 *   <li><b>Time</b>: a sequence of 32 bits that represent the creation minute.
 *   <li><b>Payload</b>: a sequence of 128 random bits generated by a secure random generator.
 * </ul>
 *
 * <p>Instances of this class are <b>immutable</b>.
 *
 * @see <a href="https://segment.com/blog/a-brief-history-of-the-uuid/">A brief history of the
 *     UUID</a>
 */
public final class Ksuid implements Serializable, Comparable<Ksuid> {
   ...
   * Creates a new KSUID.
   *
   * <p>Useful to make copies of KSUIDs.
   *
   * @param ksuid a KSUID
   */
   ...
   * Creates a new KSUID.
   *
   * <p>Seconds parameter is the number of seconds since 1970-01-01 (Unix epoch). It is internally
   * converted to KSUID time.
   *
   * <p>Payload parameter must be an array of 16 bytes.
   *
  ...
  Ksuid(byte[] bytes) {
    ...
    if (bytes == null || bytes.length != KSUID_BYTES) {
      throw new IllegalArgumentException(
          "Invalid byte array length or null"); // null or wrong length!
    }
  ...
  Ksuid(final int[] ints) {
    ...
    if (ints == null || ints.length != KSUID_INTS) {
      throw new IllegalArgumentException(
          "Invalid integer array length or null"); // null or wrong length!
    }
   ...
   *
   * <p>This static method is a quick alternative to {@link KsuidCreator#getKsuid()}.
   *
   * <p>It employs {@link SplittableRandom} which works very well, although not cryptographically
   ...
   * generator should use {@link KsuidCreator#getKsuid()}.
   *
   * @return a KSUID
   * @since 4.1.0
   */
   ...
   *
   * <p>The input string must be 27 characters long and must contain only characters from base-62
   * alphabet.
   *
   ...
   *
   * <p>The instant of creation is extracted from the creation time.
   *
   * @param string a canonical string
   ...
   *
   * <p>The number returned is equivalent to the number of seconds since 1970-01-01 (Unix epoch).
   *
   * @param string a canonical string
   ...
   * Return the payload.
   *
   * <p>The payload is an array of 16 bytes (128 bits).
   *
   * @param string a canonical string
   * @return a byte array
   */
   ...
   *
   * <p>The 4 fist bytes of contain an unsigned time since epoch 14e8.
   *
   ...
   *
   * <p>The output string is 27 characters long and contains only characters from base-62 alphabet.
   *
   * @return a string
   * @see <a href="https://segment.com/blog/a-brief-history-of-the-uuid/">A brief history of the
   *     UUID</a>
  ...
  public boolean equals(Object other) {
    ...
    if (other.getClass() != Ksuid.class) return false;
   ...
   *
   * <p>The first of two KSUID is greater than the second if the most significant byte in which they
   * differ is greater for the first KSUID.
   *
   ...
   *
   * <p>When an overflow occurs in the payload 128 bits, the time is simply incremented to
